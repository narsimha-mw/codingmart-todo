...
import com.user.oauth.exception.ResourceNotFoundException;
import com.user.oauth.model.Comment;
import com.user.oauth.model.Post;
import com.user.oauth.repository.CommentRepository;
import com.user.oauth.repository.PostRepository;
